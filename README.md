...
2. Donnez-lui un nom (ex. *bum.bike admin*), choisissez une expiration (pour faciliter les choses, sélectionnez aucune data d'expiration), et cochez la case **repo** (accès complet, toutes cases cochées) ainsi que **read:user** plus bas.
...
## Pour celle qui préfèrent modifier le site direct dans GitHub / If you prefer to modify the site directly
